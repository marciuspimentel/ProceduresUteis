...
If OBJECT_ID('JSONDeserialize') IS NOT NULL Drop Function dbo.JSONDeserialize
Go
Create Function [dbo].[JSONDeserialize]
( 
	@JSON NVARCHAR(MAX)
)
...
(
   ...
   ,Value			VARCHAR(MAX) NOT NULL		/*the string representation of the value of the element. */
   ,DataType		VARCHAR(10) NOT null		/* the declared type of the value represented as a string in StringValue*/
)
AS
BEGIN
  DECLARE
    ...
    BEGIN
      ...
      IF SUBSTRING(@value, 1, 7)='@object'
        INSERT INTO @hierarchy
          (NAME, ParentId, Value, ObjectId, DataType)
